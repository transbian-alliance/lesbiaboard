...
function Donate_FooterButton()
{
	global $footerExtraButtons;
	$footerExtraButtons .= format(
"
			<form action=\"https://www.paypal.com/cgi-bin/webscr\" method=\"post\" style=\"font-size: 10px; display: inline;\">
				<input type=\"hidden\" name=\"cmd\" value=\"_s-xclick\" />
				<input type=\"image\" src=\"plugins/paypal.png\" name=\"submit\" alt=\"Donate with PayPal!\" style=\"float: left; margin-right: 8px;\" />
...
register("footerButtons", "Donate_FooterButton");
